...
//		transfer_out_account_spn.setp
	...
	private void save(){
		...
		transfer.Account = transfer_out_account_spn.getSelectedItemPosition()+1;
		transfer.Item = transfer_info_project_spn.getSelectedItemPosition()+1;
		...
		transfer.Amount= transfer_amount;
		transfer.Account = transfer_in_account_spn.getSelectedItemPosition()+1;
		commondata.Add(transfer);
